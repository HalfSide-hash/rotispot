...
<html>
	...
	<body>
		...
		<nav class="navbar navbar-inverse" style = "background-color: #ABEBC6; color: black; margin-bottom: 0;">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav navbar-inverse">
					<li><a href="employeeindex.php" style = "background-color: #ABEBC6; color: black;"><span class="glyphicon glyphicon-user"></span> My account</a></li>
					</ul>
					
				<ul class="nav navbar-nav navbar-right">
				    <li><a href="employeelogout.php" style = "background-color: #ABEBC6; color: black;"><span class="glyphicon glyphicon-off" style= "color: red;"></span> Logout</a></li>	
				</div>
			</div>
		</nav>
	</body>
